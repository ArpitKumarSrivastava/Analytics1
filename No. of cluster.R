...
library(NbClust)
nc = NbClust(data, distance="euclidean",min.nc=2, max.nc=15, method="average")   # created the best cluster based on the majority rule by automatically taking all the possible cluster
?NbClust
...
head(data2)
nc = NbClust(data2, distance="euclidean",min.nc=2, max.nc=15, method="average")    # created the best cluster based on the majority rule by automatically taking all the possible cluster using NbClust
